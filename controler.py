...
pygame.time.set_timer(TIMER_DRAW_ZOMBY2,random.randint(0,3000),1)
TIMER_DRAW_ZOMBY3=event.custom_type()
pygame.time.set_timer(TIMER_DRAW_ZOMBY3,random.randint(0,3000),1)
TIMER_DRAW_ZOMBY4=event.custom_type()
pygame.time.set_timer(TIMER_DRAW_ZOMBY4,random.randint(0,3000),1)
TIMER_DRAW_ZOMBY5=event.custom_type()
pygame.time.set_timer(TIMER_DRAW_ZOMBY5,random.randint(0,3000),1)
TIMER_DRAW_ZOMBY6=event.custom_type()
pygame.time.set_timer(TIMER_DRAW_ZOMBY6,random.randint(3000,6000),1)
TIMER_DRAW_ZOMBY7=event.custom_type()
pygame.time.set_timer(TIMER_DRAW_ZOMBY7,random.randint(3000,6000),1)
